...
end_date = "2025-04-01"  # Specific end date

# Create an Excel writer to store multiple stock data in one Excel file
with pd.ExcelWriter("fno_stocks_data_past_10_years_endate.xlsx", engine="openpyxl") as writer:
    for stock in stocks:
        try:
...
print("🔥Download complete! Data saved to fno_stocks_data_past_10_years_endate.xlsx.")
